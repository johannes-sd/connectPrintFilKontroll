...
hbs.registerPartials('C:\\Users\\johannes.SD\\node\\connectPrintFilKontroll\\' + "views\\partials");


app.set('view engine', 'hbs');
app.set('views','C:\\Users\\johannes.SD\\node\\connectPrintFilKontroll\\' + 'views');
app.use(express.static('C:\\Users\\johannes.SD\\node\\connectPrintFilKontroll\\' + 'public'));
app.use(helmet());
